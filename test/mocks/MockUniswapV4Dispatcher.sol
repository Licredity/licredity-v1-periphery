...
contract MockUniswapV4Dispatcher {
    ...
    function uniswapPoolManagerCall(bytes calldata swapCalldata) external payable {
        UniswapV4Dispatcher.uniswapPoolManagerCall(uniswapV4Mock, swapCalldata);
    }
    ...
    function uniswapPoolSwapCall(bytes calldata swapCalldata) external payable {
        UniswapV4Dispatcher.uniswapPoolSwapCall(uniswapV4Mock, swapCalldata);
    }
}
